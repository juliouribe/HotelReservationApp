...
public class ServiceTester {
    public static void main(String[] args) {
        ...
        LocalDate laterCheckIn = checkIn.plusDays(1);
        ...
        System.out.println(ReservationService.getInstance().reserveARoom(secondCustomer, desiredRoom, laterCheckIn, earlierCheckout));
        System.out.println();
